          ...
          <div className="col-lg-6 mb-4">
            <div className="pe-lg-4">
              ...
              <p className="">
                ...
                {' '}
                es de carácter confidencial y anónimo, según corresponda para toda persona que
                {' '}
                tenga información de alguna actividad desarrollada por la empresa o algún
                {' '}
                colaborador, proveedor de la misma, que pudiese implicar una violación a nuestros
                {' '}
                valores, leyes, normativa, códigos,reglamentos o políticas internas, y principios
                {' '}
                éticos en general.
              </p>
              <p>
