...
const NewCard = ({ title, slug, image, author, excerpt, tags }) => (
  <Card
    containerClassName="p-2 w-3/4 lg:w-11/12 mx-auto"
    cardClassName="flex flex-col min-w-72 group shadow-none hover:shadow-none border-none"
    header={
      <a
        href={`/prensa/${slug}`}
        className="overflow-hidden min-h-64 rounded-3xl group border-2 border-soft-blue"
      >
        <Image
